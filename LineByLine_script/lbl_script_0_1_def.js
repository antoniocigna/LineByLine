...
let prototype_word_tr_m1_tts = ` 			
         <tr id="widtr_§1§_m1" class="playBut1" style="display:none;background-color:lightgrey;">
            <td class="c_m1"></td>
            <td class="c_m1"></td>
            <td class="playBut1 c_m1">
...
let prototype_word_tr_tts = `				
         <tr id="widtr_§1§" style="background-color: lightgrey;">
            ...
            <td >              
			   <div class="suboLine" style="display:none;" id="widc_§1§">§4txt§</div>
			   <div></div><div></div>
...
//------------------------------------
	...
	let str_td_xx_insertPause = `	
			...
			` ; // end str_td_xx_insertPause 	
	//-----------
	let str_td_xx_last5col = `		
			<td class="timerow1">§1§</td>
		</tr> 
		`; // end let str_td_xx_last5col;
//----------------------


	let string_tr_xx = "";		
	let string_tr_xx_pre_voices  = str_tr_xx_1.trim() + "\n"+ 
		str_td_xx_insertPause.trim() + "\n" + 
		""; 

	let string_tr_xx_post_voices =  str_td_xx_playTTS_Loop.trim() + "\n"  + 			
				'<td class="timerow1">§1§</td>'				
				"</tr> \n"; 
