...
function onclick_tts_get_oneLangVoice(this1) {
	...
	/**
	console.log(" onclick_tts_get_oneLangVoice(this1)  voices=\n"); 
	for(var y=0; y < voices.length; y++) {
		console.log("\t" + y + " \t " + voices[y].lang + " " + voices[y].name.substr(0,20));   
	}
	**/
	var ix = this1.value; 	
...
function onclick_tts_arrowFromIx( this1, z3, wh) {
	...
	//------------------------------------------
	if (z3==0) { console.log(" onclick_tts_arrowFromIx( this1, z3=" +z3 + ", wh=" + wh); } 
...
//-------------------------------------------------
function TOGLIonclick_tts_playSynthVoice_row2(this1, ixTD, swPause,swNewVoice) {
		...
		if (tts_3_play_or_cancel(this1) < 0) {
	     ...
	     try {
	         ...
	         console.log("script_3 onclick_tts_playSynthVoice_row(this=" + this1.id + " ixTD=" + ixTD + " ixVoice=" + ixVoice);
	...
	//console.log("\nonclick_tts_playSynthVoice_row()  ixTD=" + ixTD + " ixVoice=" + ( ixTD - 1)+ " swNewVoice="+ swNewVoice + "  lastNumVoice=" + lastNumVoice);
		...
		onclick_tts_text_to_speech2(txt3, 4);
...
function onclick_tts_seeWords(this1, numId) {	
